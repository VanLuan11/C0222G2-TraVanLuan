package com.example.shoponlineapi.controller.simple_email;
...
public class SimpleEmailController {
    ...
    public ResponseEntity<?> sendSimpleEmail(@RequestBody JwtRequest jwtRequest) throws MessagingException, javax.mail.MessagingException {
